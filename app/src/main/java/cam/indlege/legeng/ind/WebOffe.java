...
public class WebOffe extends WebView {
    public WebOffe(@NonNull Context context) {
        super(context);
    }

    public WebOffe(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    private void flf(){
        this.setWebViewClient(new Ldf());
        this.setWebChromeClient(new ldsdj());
    }
